...
export default function ReanimatedWall() {
    ...
    <View style={styles.screen}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.sub}>
            {particles.length} particles · CSS Transitions
          </Text>
        </View>
        <View style={styles.badge}>
          <Text style={styles.badgeText}>Reanimated</Text>
        </View>
      </View>
      ...
      {jsLoad && (
        <Text style={styles.warning}>
          JS thread blocked — wave triggers become unresponsive
        </Text>
      )}
